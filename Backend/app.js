...
const openReqForSwitchRole=require('./routes/openReqForSwitchRole');
const pendingReqForSwitchRole=require('./routes/pendingReqForSwitchRole');
const closeReqForSwitchRole=require('./routes/closeReqForSwitchRole');
...
app.use(addWorkFlow);
app.use(config1);
app.use(openReqForSwitchRole);
app.use(pendingReqForSwitchRole);
app.use(closeReqForSwitchRole);
module.exports = app;
