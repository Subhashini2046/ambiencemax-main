let express = require("express"),
  ...
  router.post("/dashboard", (req, res) => {
    ...
    //                           console.log(w_id);
    //                           sql5 = `select count(*) as "all" from requests where w_id = '${w_id}';select count(*) as "pending" from requests where w_id = '${w_id}' and req_status = 'Pending';select count(*) as "closed" from requests where w_id = '${w_id}' and req_status = 'Closed';select count(*) as "open" from requests where w_id = '${w_id}' and req_level = '${role_id - 1 }'`;
  ...
  router.post("/dashboard1",(req,res)=>{
    ...
    w_id=req.body.w_id;
    console.log(w_id);
    sql = `select count(*) as "all" from requests where w_id = '${w_id}';select count(*) as "pending" from requests where w_id = '${w_id}' and req_status = 'Pending';select count(*) as "closed" from requests where w_id = '${w_id}' and req_status = 'Closed';select count(*) as "open" from requests where w_id = '${w_id}' and req_level = '${role_id - 1 }';`
