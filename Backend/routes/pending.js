                      ...
                      if(err){
                        ...
                        if(result.length > 0){
                          ...
                          const loop = new Promise((resolve,reject) =>{  result.forEach((element,index) => {
                                ...
                                console.log(w_id);
                                sql5 = `Select * from requests where req_status = 'Pending' and w_id = '${w_id}' order by req_id desc;select count(*) as "pending" from requests where w_id = '${w_id}' and req_status = 'Pending'`;
